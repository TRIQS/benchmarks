...
# # Hubbard Atom
#
# Single atomic level with on-site Coulomb repulsion $U$ and magnetic field $h$.
#
# $$H = -\mu(n_{\uparrow} + n_{\downarrow}) - h(n_{\uparrow} - n_{\downarrow}) + U n_{\uparrow} n_{\downarrow}$$
